...
const EventForm =(props)=> {
  ...
  const handleSubmit = () => {
    addEvent({title,date,month,day,time,location,description,eventName,ticketID,active,ticketStatus,profile})
  }
    ...
    return (
      <Form inverted >
        ...
        <div style={{gridColumnStart:'1'}}>
        <Form.TextArea label='Description' placeholder='Tell us about the event...' onChange={(e)=>(setDescription(e.target.value))} />
        </div>
